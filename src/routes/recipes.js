...
const { suggestRecipes, familyRecipe, getSubstitutions, estimateCosts, suggestDrinks, describeRecipe } = require('../controllers/recipeController')
...
router.post('/describe', auth, describeRecipe)
