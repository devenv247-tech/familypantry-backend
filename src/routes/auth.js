...
const { register, login, deleteAccount, forgotPassword, resetPassword, updateAccount, logout, acceptInvite, confirmEmailChange } = require('../controllers/authController')
